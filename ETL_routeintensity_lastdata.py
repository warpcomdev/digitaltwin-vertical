...
def get_geometry_format(lista_puntos: List) -> str:
    ...
    #lista_puntos = ast.literal_eval(lista_puntos)
    ...
    # multiline = json.loads(multiline)
...
def etl_routeintensity_lastdata() -> pd.DataFrame:
    """
...
if __name__ == '__main__':
    ...
    logging.info('Start of execution ETL_routeintensity_lastdata')

    df = etl_routeintensity_lastdata()
    if df.empty:
